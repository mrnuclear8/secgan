...
parser.add_argument("--epoch", type=int, default=39, help="epoch to start training from")
parser.add_argument("--n_epochs", type=int, default=100, help="number of epochs of training")
parser.add_argument("--dataset_name", type=str, default="cartoonCity_MS-SSIM_hinet_l1B", help="name of the dataset")
...
parser = argparse.ArgumentParser()
parser.add_argument("--epoch", type=int, default=33, help="epoch to start training from")
parser.add_argument("--n_epochs", type=int, default=100, help="number of epochs of training")
parser.add_argument("--dataset_name", type=str, default="cartoonCity_MS-SSIM_hinet_l1B", help="name of the dataset")
parser.add_argument("--batch_size", type=int, default=1, help="size of the batches")
parser.add_argument("--lr", type=float, default=0.00005, help="adam: learning rate")
...
# Image transformations
transforms_ = [
    transforms.Resize(int(512), Image.BICUBIC),
...
def sample_images(batches_done):
    ...
    save_image(image_grid, "./test.png", normalize=False)
